...
% Monoexp model
 ...
 limit_mono= [log(0.0001);log(0.05)];
...
%TV parameters(alpha, const and TV iteration)
 ...
 TViter=10;
%% Codes to run
 [paraMap,resnorm,stats_roi]=hyModel(dwiData,b,limit_hy,D0_hy,tumor,stats);
 [paraMapTV,resnormTV,stats_roiTV]=hyModelTV(dwiData,b,limit_hy,D0_hy,tumor,...
